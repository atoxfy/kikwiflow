...
public class ExclusiveGatewayDefinitionMapper {

    public static ExclusiveGatewayDefinition mapToDefinition(Document doc) {
    ...
    public static void mapToDoc(Document doc, ExclusiveGatewayDefinition gt){
