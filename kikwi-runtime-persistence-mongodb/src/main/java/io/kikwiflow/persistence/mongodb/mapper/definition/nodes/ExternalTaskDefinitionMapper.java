...
public class ExternalTaskDefinitionMapper {

    public static ExternalTaskDefinition mapToDefinition(Document doc) {
    ...
    public static void toDocument(Document doc, ExternalTaskDefinition mt) {
