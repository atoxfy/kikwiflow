...
public class NonInterruptiveTimerEventDefinitionMapper {

    public static NonInterruptiveTimerEventDefinition mapToDefinition(Document doc) {
        ...
        return NonInterruptiveTimerEventDefinition.builder()
                ...
                .schedulePolicy(SchedulePolicyMapper.mapToDefinition(doc))
    ...
    public static void mapToDocument(Document doc, NonInterruptiveTimerEventDefinition te){
        doc.append("attachedToRef", te.attachedToRef());
        SchedulePolicy schedulePolicy = te.schedulePolicy();
        SchedulePolicyMapper.mapToDocument(doc, schedulePolicy);
    }
}
