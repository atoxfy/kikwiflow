...
public class ErrorHandlerDefinitionMapper {

    public static ErrorHandlerDefinition mapToDefinition(Document doc) {

        return ErrorHandlerDefinition.builder()
                .id(doc.getString("id"))
    ...
    public static void mapToDocument(Document doc, ErrorHandlerDefinition te){
        doc.append("attachedToRef", te.attachedToRef());
        doc.append("errorCode", te.errorCode());
    }
