...
public class ParallelGatewayDefinitionMapper {

    public static ParallelGatewayDefinition mapToDefinition(Document doc) {
    ...
    public static void mapToDocument(Document doc, ParallelGatewayDefinition gt){
