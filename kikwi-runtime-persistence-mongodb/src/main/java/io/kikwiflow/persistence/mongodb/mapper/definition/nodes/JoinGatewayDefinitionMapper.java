...
public class JoinGatewayDefinitionMapper {

    public static JoinGatewayDefinition mapToDefinition(Document doc) {
    ...
    public static void mapToDocument(Document doc, JoinGatewayDefinition gt){
