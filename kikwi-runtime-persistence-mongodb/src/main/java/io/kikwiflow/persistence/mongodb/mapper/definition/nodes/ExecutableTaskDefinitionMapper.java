...
public class ExecutableTaskDefinitionMapper {

    public static ExecutableTaskDefinition mapToDefinition(Document doc) {
        ...
        return ExecutableTaskDefinition.builder()
                ...
                .retryPolicy(RetryPolicyMapper.mapToDefinition(doc))
    ...
    public static void toDocument(Document doc, ExecutableTaskDefinition st){
