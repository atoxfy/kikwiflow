...
@Component("requestAccountOpening")
public class RequestAccountOpeningTaskHandler implements TaskHandler {
    private static Logger logger = LogManager.getLogger(RequestAccountOpeningTaskHandler.class);

    @Override
    public void handle(ExecutionContext execution) {
        String threadName = Thread.currentThread().getName();
        logger.info("[{}] RequestAccountOpeningTaskHandler - Iniciando handle para instância: {}", threadName, execution.getProcessInstanceId());
