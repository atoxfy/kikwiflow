...
public record StartEventDefinitionSnapshot(String id,
                                           String name,
                                           String description,
                                           Boolean commitAfter,
    ...
    public static class Builder {
        ...
        public StartEventDefinitionSnapshot build() {
            return new StartEventDefinitionSnapshot(id, name, description, commitAfter, commitBefore, outgoing);
        }
    }
}
