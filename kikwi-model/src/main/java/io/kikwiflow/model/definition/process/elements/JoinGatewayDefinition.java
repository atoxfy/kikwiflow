...
public record JoinGatewayDefinition(String id,
                                    String name,
                                    String type,
                                    String description,
                                    Boolean commitAfter,
    ...
    public static class Builder {
        ...
        public Builder sourceSplitId(String sourceSplitId) {
        ...
        public JoinGatewayDefinition build() {
            return new JoinGatewayDefinition(id,
                    name,
                    "JOIN_GATEWAY",
                    description,
                    commitAfter,
