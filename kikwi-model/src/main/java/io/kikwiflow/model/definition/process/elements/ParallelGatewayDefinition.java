...
public record ParallelGatewayDefinition(String id,
                                        String name,
                                        String type,
                                        String description,
                                        Boolean commitAfter,
    ...
    public static class Builder {
        ...
        public Builder targetJoinId(String targetJoinId) {
            this.targetJoinId = targetJoinId;
            return this;
        }
        ...
        public ParallelGatewayDefinition build() {
            return new ParallelGatewayDefinition(id,
                    name,
                    "PARALLEL_GATEWAY",
                    description,
                    commitAfter,
