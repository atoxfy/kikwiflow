...
public record ErrorHandlerDefinition(String id,
                                     String name,
                                     String type,
                                     String description,
                                     Boolean commitAfter,
    ...
    public static ErrorHandlerDefinition.Builder builder() {
        return new ErrorHandlerDefinition.Builder();
    }
    ...
    public static class Builder {
        ...
        public ErrorHandlerDefinition build() {
            return new ErrorHandlerDefinition(id, name, "BOUNDARY_ERROR_HANDLER", description, commitAfter, commitBefore, outgoing, attachedToRef, errorCode, extensionProperties, layout);
        }
    }
}
